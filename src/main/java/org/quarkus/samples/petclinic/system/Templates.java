...
public class Templates {
    public static native TemplateInstance login(String message, Map<String, String> errors);

    public static native TemplateInstance register(String message, Map<String, String> errors);
