...
import org.quarkus.samples.petclinic.login.Login;
...
public class TemplatesLocale {
    ...
    public TemplateInstance login(String message, Map<String, String> errors) {
        return Templates.login(message, errors).setAttribute("locale", getConfiguredLocale());
    }

    public TemplateInstance register(String message, Map<String, String> errors) {
        return Templates.register(message, errors).setAttribute("locale", getConfiguredLocale());
    }
